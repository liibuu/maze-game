...
public class CollisionPlayer extends Collision {
    public CollisionPlayer (int mapWidth, int mapHeight) {
    ...
    public int[] nearByRightIndex (Table table, float x, float y) {
        ...
        int rightMidLeftIndex = rightLeftX * mapWidth + rightMidY;
        int rightMidRightIndex = rightRightX * mapWidth + rightMidY;
    ...
    public int[] nearByLeftIndex (Table table, float x, float y) {
        ...
        int leftMidLeftIndex = leftLeftX * mapWidth + leftMidY;
        int leftMidRightIndex = leftRightX * mapWidth + leftMidY;
